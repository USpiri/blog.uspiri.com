...
El script se puede modificar según las necesidades, por ejemplo, haciendo que al hacer click _fuera del marco del dialog_ este se cierre. Se puede ver el funcionamiento del mismo en este blog, haciendo click en la lupa de la barra de navegación.
