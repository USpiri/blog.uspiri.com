...
date: 2023-10-21
description: "Una funcionalidad útil a la hora de pensar en el desarrollo de un blog de programación con Astro"
...
Es resultado son los botónes que se ven en los `codeblocks` de este Blog. Aquí está el código completo:

<NavigationCard
  label='"Copy code" snippet'
  href="/snippet/javascript/copy-button"
></NavigationCard>
